...
lambda_vec = [1e4 1e4 1e5 1e6];
lambda_txt = [{'1e4'},{'1e4'},{'1e5'},{'1e6'}];
...
load(['400vanSYM100_' num_ph '_exp1.mat']); %400vanSYM_1e7_exp1
Imin = I;
...
%         cd('./fig_journal')
%         %cd('./fig_patent')
%         txt = ['50MUX1_train2_' num_ph '_' lambda_txt '_' num2str(id) '.mat'];
